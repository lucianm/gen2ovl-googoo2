...
DEPEND="media-libs/aalib
		...
		media-video/ffmpeg:0[pulseaudio=,jack=,aac=,modplug=,ieee1394=,speex=,theora,v4l=,vaapi,vorbis,alsa]
		sys-apps/dbus
		media-video/dirac
		...
		matroska? ( media-libs/libmatroska dev-libs/libebml media-libs/libmkv )
